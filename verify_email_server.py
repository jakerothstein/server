...
password = "lmmfblpmgdjvpyhg"
sender = "ilikegta12345678@gmail.com"


def send_verifacation_email(email, code):
    link = f"http://45.76.169.92:8000/verify-otp/{email}/{code}"
...
def reset_password_email(email, code):
    link = f"http://45.76.169.92:8000/reset-password/{email}/{code}"
